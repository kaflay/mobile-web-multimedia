...
namespace Ghumfir.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ContactsController(ghumfirContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Subject,Message")] Contact contact)
        {
            ...
            TempData["Message"] = "Contacts updated successfully!";
            return View(contact);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ghumfirContext.Contacts'  is null.");
            }
            var contact = await _context.Contacts.FindAsync(id);
            if (contact != null)
            {
            ...
            TempData["Message"] = "Contacts deleted successfully!";
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
